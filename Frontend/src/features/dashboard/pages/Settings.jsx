...
import { useDeleteWorkspace } from "../../workspace/hooks/useWorkspace";
...
const Settings = () => {
  ...
  return (
    <div className="w-full h-full flex overflow-hidden">
      ...
      {/* ── Left sidebar nav ── */}
      <aside className="w-60 shrink-0 border-r border-theme-border bg-theme-card flex flex-col pt-8 pb-4 theme-transition">
        ...
        <nav className="flex flex-col px-3 gap-0.5">
          {NAV_SECTIONS.map(({ id, label, icon: Icon, danger }) => (
            <button
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium w-full text-left theme-transition cursor-pointer border-none ${
                activeSection === id
                  ? danger
            ...
            >
              {activeSection === id && !danger && (
                <span className="absolute left-3 w-0.5 h-4 rounded-full bg-brand-blue" />
              )}
      ...
      {/* ── Main content ── */}
      <div className="flex-1 overflow-y-auto px-10 py-10 theme-transition">
          ...
          {activeSection === "danger" && (
            <section className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between p-5 rounded-xl border border-red-500/25 bg-red-500/5 theme-transition">
                ...
                <button
                  disabled
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-red-500/30 text-red-400 text-sm font-semibold theme-transition opacity-50 cursor-not-allowed shrink-0 ml-6"
                >
                  Leave
              ...
              <div className="flex items-center justify-between p-5 rounded-xl border border-red-500/30 bg-red-500/8 theme-transition">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-red-500 text-white text-sm font-semibold hover:bg-red-600 theme-transition active:scale-[0.97] cursor-pointer shrink-0 ml-6"
                >
                  <Trash2 size={14} />
                  Delete
                </button>
