...
const ResetPassword = () => {
  ...
  const onSubmit = (data) => {
    ...
    // You can hook up your mutation here
    reset();
  };
        ...
        <div className="w-full max-w-md bg-theme-card border border-theme-border rounded-2xl px-9 pt-10 pb-8 flex flex-col theme-transition duration-300">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 mb-5">
            ...
            <button
              type="submit"
              id="reset-submit-btn"
              className="w-full py-3 mt-2 rounded-lg bg-theme-btn-cta-bg text-theme-btn-cta-text text-[0.8125rem] font-bold tracking-[0.08em] cursor-pointer hover:opacity-90 active:scale-[0.98] theme-transition duration-200 border-none font-sans"
            >
              SEND RESET LINK
            </button>
          </form>
