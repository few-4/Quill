        ...
        <div className="w-full max-w-md bg-theme-card border border-theme-border rounded-2xl px-9 pt-10 pb-8 flex flex-col theme-transition duration-300">
          ...
          <form className="flex flex-col gap-4 mb-5" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="register-fullname" className="text-[0.8125rem] font-medium text-theme-txt-primary tracking-[-0.01em] theme-transition duration-300">
                Full Name
              </label>
              <input
              ...
              />
              {errors.fullName && <p className="text-blue-500 text-sm">{errors.fullName.message}</p>}
            </div>

            <div className="flex flex-col gap-1.5">
              <label htmlFor="register-username" className="text-[0.8125rem] font-medium text-theme-txt-primary tracking-[-0.01em] theme-transition duration-300">
                Username
              </label>
              <input
